...
import { PracticeExercise as PracticeExerciseType, TestResult } from '@/types/exercise';
...
export default function PracticeExercise({ exercise, darkMode = false, onComplete }: PracticeExerciseProps) {
